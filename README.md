...
[![Phase 5](https://img.shields.io/badge/Phase%205-Specialization-993C1D?style=flat-square)](./Phase-5)
[![Phase 6](https://img.shields.io/badge/Phase%206-Capstone-3B6D11?style=flat-square)](./Phase-6)
...
│
├── Phase-1_April_Foundations/
│   ├── Week-01_Python-NumPy/
│   │   ├── Day-01_Setup-NumPy/
│   │   ├── Day-02_Image-Representation/
│   │   ├── Day-03_Linear-Algebra/
│   │   ├── Day-04_Statistics-Histograms/
│   │   └── Day-05_Project-Stats-Dashboard/
│   ├── Week-02_Image-Processing/
│   │   ├── Day-06_Color-Spaces/
│   │   ├── Day-07_Filtering-Convolution/
│   │   ├── Day-08_Edge-Detection/
│   │   ├── Day-09_Morphological-Ops/
│   │   └── Day-10_Project-Preprocessing-Pipeline/
│   ├── Week-03_Geometric-Transforms/
│   │   ├── Day-11_Affine-Perspective-Transforms/
│   │   ├── Day-12_Contours-Shape-Analysis/
│   │   ├── Day-13_Hough-Transforms/
│   │   ├── Day-14_Segmentation-Watershed/
│   │   └── Day-15_Project-Document-Scanner/
│   └── Week-04_Feature-Detection/
│       ├── Day-16_Harris-FAST/
│       ├── Day-17_SIFT-SURF-ORB/
│       ├── Day-18_Feature-Matching/
│       ├── Day-19_Optical-Flow/
│       └── Day-20_Project-Panorama-Stitcher/
│
├── Phase-2_May_Classical-ML/
│   ├── Week-05_ML-Fundamentals/
│   │   ├── Day-21_ML-Core-Concepts/
│   │   ├── Day-22_HOG-LBP-Features/
│   │   ├── Day-23_PCA-Eigenfaces/
│   │   ├── Day-24_Sliding-Window-Detection/
│   │   └── Day-25_Project-Face-Detector/
│   ├── Week-06_BoVW-Clustering/
│   │   ├── Day-26-27_kMeans-BoVW/
│   │   ├── Day-28_Image-Retrieval/
│   │   ├── Day-29_Evaluation-Metrics/
│   │   └── Day-30_Project-CBIR-System/
│   ├── Week-07_Video-Analysis/
│   │   ├── Day-31_Background-Subtraction/
│   │   ├── Day-32_Object-Tracking/
│   │   ├── Day-33_Dense-Optical-Flow/
│   │   ├── Day-34_Camera-Calibration/
│   │   └── Day-35_Project-Security-System/
│   └── Week-08_Phase2-Integration/
│       ├── Day-36-38_Vehicle-Counting-System/
│       └── Day-39-40_Portfolio-Writeup/
│
├── Phase-3_June_Deep-Learning/
│   ├── Week-09_Neural-Networks/
│   ├── Week-10_CNN-Architectures/
│   ├── Week-11_Object-Detection/
│   ├── Week-12_Segmentation/
│   ├── Week-13_Transformers/
│   └── Week-14_ViT-Capstone/
│
├── Phase-4_July_Advanced-DL/
│   ├── Week-15_GANs-VAEs/
│   ├── Week-16_3D-Vision/
│   ├── Week-17_Self-Supervised/
│   └── Week-18_Optimization-Deployment/
│
├── Phase-5_Agust_Specialization/
│   ├── Week-19_Face-Recognition/
│   ├── Week-20_Pose-Estimation/
│   ├── Week-21_OCR-DocumentAI/
│   └── Week-22_Autonomous-Vehicle/
│
├── Phase-6_September_Capstone/
│   ├── Week-23_Paper-Implementation/
│   ├── Week-24_Capstone-Build/
│   ├── Week-25_Deploy-Document/
│   └── Week-26_Interview-Portfolio/
│
├── resources/
│   ├── cheatsheets/
│   ├── paper-notes/
...
cd Phase-1_Foundations/Week-04_Feature-Detection/Day-20_Project-Panorama-Stitcher
